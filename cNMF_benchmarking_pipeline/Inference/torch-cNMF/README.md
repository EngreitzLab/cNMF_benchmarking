...
* To run sk-cNMF, run `pip install git+https://github.com/ymo6/torch_based_cNMF.git` in the terminal
    ...
    | beta_loss | str or float | - | Beta loss metric for approximation. Options: "frobenius" (L2), "kullback-leibler" (KL), "itakura-saito" (IS), or float value |
    ...
    | solver | str | "halsvar" | Algorithm choice: "mu", "hals", "halsvar", "bpp" |
